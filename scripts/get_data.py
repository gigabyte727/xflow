...
os.environ["MLFLOW_REGISTRY_URI"] = "/home/igor/xflow/mlflow/"
mlflow.set_tracking_uri("http://localhost:5000")
mlflow.set_experiment("get_data_1")

# Инициализация объекта API, Youtube
key = "AIzaSyDvrYMFgfVslAS524AlCiHPupDNQ8ZgW1E"
api = Api(api_key=key)
...
with mlflow.start_run():
    ...
    mlflow.log_artifact(local_path="/home/igor/xflow/scripts/get_data.py",
                        artifact_path="get_data code")
    mlflow.end_run()

with open('/home/igor/xflow/datasets/data.csv', 'a') as f:
    f.write("{}\n".format(s))
